...
export const DOCUMENTS_TABLE_COLUMNS: ColumnMeta[] = [
  ...
  { id: 'pageNumber', label: 'Page', isLocked: false },
  { id: 'batch', label: 'Batch', isLocked: false },
  { id: 'batchType', label: 'Batch Type', isLocked: false },
  { id: 'confidence', label: 'Confidence', isLocked: false },
  { id: 'reference', label: 'Reference', isLocked: false },
  { id: 'customer', label: 'Customer', isLocked: false },
  { id: 'order', label: 'Order', isLocked: false },
  { id: 'fulfillment', label: 'Fulfillment', isLocked: false },
