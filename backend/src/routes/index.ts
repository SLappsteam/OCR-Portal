...
import { authenticate, authenticatePreview } from '../middleware/authenticate';
...
router.use('/api/preview', authenticatePreview, storeScope, previewRouter);
...
router.use('/api/audit-logs', authenticate, requireRole('admin'), auditLogsRouter);
